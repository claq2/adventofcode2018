...
public:
	...
	void MoveNextCart(std::pair<const std::pair<int, int>, int> &locationAndId, std::vector<std::vector<char>>& tracks, std::map<int, std::tuple<int, int, Day13::Direction, Day13::NextJunctionAction>>& cartsAndDirections);
};
